...
MSIX requires numeric package versions. The app release `1.0.0` maps to MSIX version `1.0.0.0`.
...
4. Upload `PersistentSage_1.0.0.0_x64.msix` to Partner Center.
...
The generated `PersistentSage_1.0.0.0_x64.msix` should appear in the repository root.
...
npm run msix:pack
Add-AppxPackage .\PersistentSage_1.0.0.0_x64.msix
```
