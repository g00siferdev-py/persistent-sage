...
1. Confirm version in `package.json` and `src-tauri/tauri.conf.json` (e.g. `0.2.0-beta.6`).
...
3. **Choose a tag:** create `v0.2.0-beta.6` on `main`.
4. Title: `Persistent Sage 0.2.0-beta.6`
...
2. CHANGELOG entry.
3. Push `main`, then tag `v0.2.0-beta.6` (or next version).
