...
**Windows users who want a pre-built installer:** see **[INSTALL-WINDOWS.md](./INSTALL-WINDOWS.md)**. **Current release:** [Releases → Latest](https://github.com/g00siferdev-py/persistent-sage/releases/latest) (`v3.0.0`).
