...
**Baseline:** Desktop **v3.0.0** (beta: `v3.0.0-beta.1`; Store GA Aug 3)  
**Date:** June 2026  
...
- **Desktop release:** v3.0.0 beta on GitHub; Store 3.0 planned Aug 3 — Moltbook, PDF tools, Favorites, Share, personality updates
